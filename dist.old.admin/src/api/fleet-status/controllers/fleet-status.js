...
exports.default = strapi_1.factories.createCoreController('api::fleet-status.fleet-status', ({ strapi }) => ({
    async create(ctx) {
        ...
        const hasImages = (data === null || data === void 0 ? void 0 : data.images) && Array.isArray(data.images) && data.images.length > 0;
        const hasComment = (data === null || data === void 0 ? void 0 : data.comment) && typeof data.comment === 'string' && data.comment.trim() !== '';
