...
exports.default = strapi_1.factories.createCoreController('api::notification.notification', ({ strapi }) => ({
    ...
    async create(ctx) {
        ...
        strapi.log.info('🔍 [notification.create] Datos recibidos:', {
            ...
            hasReminderType: !!(data === null || data === void 0 ? void 0 : data.reminderType),
            hasModule: !!(data === null || data === void 0 ? void 0 : data.module),
            reminderType: data === null || data === void 0 ? void 0 : data.reminderType,
            module: data === null || data === void 0 ? void 0 : data.module,
            title: data === null || data === void 0 ? void 0 : data.title,
            hasRecipient: !!(data === null || data === void 0 ? void 0 : data.recipient),
            hasScheduledDate: !!(data === null || data === void 0 ? void 0 : data.scheduledDate),
        });
        ...
        const reminderTypeValue = data === null || data === void 0 ? void 0 : data.reminderType;
        const moduleValue = data === null || data === void 0 ? void 0 : data.module;
        ...
        const hasModule = moduleValue !== undefined &&
            ...
            moduleValue.trim() !== '';
        const isCompleteReminder = (data === null || data === void 0 ? void 0 : data.type) === 'reminder' && (hasReminderType || hasModule);
        strapi.log.info('🔍 [notification.create] Evaluación de recordatorio completo:', {
            isCompleteReminder,
            type: data === null || data === void 0 ? void 0 : data.type,
            typeIsReminder: (data === null || data === void 0 ? void 0 : data.type) === 'reminder',
            hasReminderType,
            hasModule,
        ...
        if (isCompleteReminder) {
            ...
            if (!(data === null || data === void 0 ? void 0 : data.module) || !['fleet', 'inventory', 'billing', 'deal', 'client', 'service'].includes(data.module)) {
        ...
        if (isCompleteReminder && (data === null || data === void 0 ? void 0 : data.title) && (data === null || data === void 0 ? void 0 : data.module)) {
            try {
                const filters = {
                    type: { $eq: 'reminder' },
                    title: { $eq: data.title },
                ...
                const existingReminders = await strapi.entityService.findMany('api::notification.notification', {
                    filters,
                ...
                const mainReminders = existingReminders.filter((reminder) => {
                    try {
                ...
                const recentDuplicates = mainReminders.filter((reminder) => {
                ...
                if (recentDuplicates.length > 0) {
                    ...
                    const existingReminder = await strapi.entityService.findOne('api::notification.notification', duplicate.id, {
    ...
    async update(ctx) {
        ...
        if ((data === null || data === void 0 ? void 0 : data.type) === 'reminder') {
            ...
            if (shouldSync && (result === null || result === void 0 ? void 0 : result.data)) {
                try {
    ...
    async delete(ctx) {
        ...
        try {
            ...
            if (numericId) {
                notificationToDelete = await strapi.entityService.findOne('api::notification.notification', numericId, {
                ...
                notificationToDelete = allNotifications.find((n) => n.documentId === notificationId) || null;
                ...
                if (!notificationToDelete && allNotifications.length === 1000) {
                    ...
                    while (hasMore && page <= 10) { // Buscar en máximo 10 páginas (10,000 notificaciones)
                        const pageNotifications = await strapi.entityService.findMany('api::notification.notification', {
                            fields: ['id', 'type', 'tags', 'title', 'module'],
                            populate: ['fleetVehicle'],
                            pagination: {
                                page,
                        ...
                        notificationToDelete = pageNotifications.find((n) => n.documentId === notificationId) || null;
                ...
                if (notificationToDelete && notificationToDelete.id) {
                    notificationToDelete = await strapi.entityService.findOne('api::notification.notification', notificationToDelete.id, {
                        fields: ['id', 'type', 'tags', 'title', 'module'],
                        populate: ['fleetVehicle'],
                    });
                }
                ...
                if (!tags || !tags.parentReminderId) {
                    ...
                    if (notificationToDelete.title && notificationToDelete.module === 'fleet' && notificationToDelete.fleetVehicle) {
                        ...
                        if (vehicleId) {
                            ...
                            const allReminders = await strapi.entityService.findMany('api::notification.notification', {
                                filters: {
                                    type: { $eq: 'reminder' },
                            ...
                            // Filtrar solo recordatorios principales (sin parentReminderId)
                            const duplicateMainReminders = allReminders.filter((reminder) => {
                                try {
                            ...
                            const currentReminderInList = duplicateMainReminders.find((r) => r.id === notificationToDelete.id);
                            ...
                            for (const duplicate of duplicateMainReminders) {
                                try {
                                    ...
                                    const deleteResult = await strapi.entityService.delete('api::notification.notification', duplicate.id);
                                    strapi.log.info(`✅ DELETE: Recordatorio duplicado eliminado: ID ${duplicate.id}`, {
                                        deleteResult,
                                    });
                                    // Verificar que realmente se eliminó
                                    try {
                                        const verifyDeleted = await strapi.entityService.findOne('api::notification.notification', duplicate.id, { fields: ['id'] });
                                        if (verifyDeleted) {
                                        ...
                                        if ((verifyError === null || verifyError === void 0 ? void 0 : verifyError.status) === 404 || ((_a = verifyError === null || verifyError === void 0 ? void 0 : verifyError.message) === null || _a === void 0 ? void 0 : _a.includes('not found'))) {
        ...
        if (notificationToDelete && notificationToDelete.id) {
            try {
                ...
                const deleteResult = await strapi.entityService.delete('api::notification.notification', notificationToDelete.id);
                ...
                try {
                    ...
                    const verifyDeleted = await strapi.entityService.findOne('api::notification.notification', notificationToDelete.id, { fields: ['id'] });
                    if (verifyDeleted) {
                    ...
                    // Si findOne lanza error, probablemente significa que fue eliminado
                    if ((verifyError === null || verifyError === void 0 ? void 0 : verifyError.status) === 404 || ((_b = verifyError === null || verifyError === void 0 ? void 0 : verifyError.message) === null || _b === void 0 ? void 0 : _b.includes('not found'))) {
    ...
    async cleanupDuplicates(ctx) {
        ...
        try {
            ...
            for (const notification of allNotifications) {
                checkTimeout();
                const recipientId = ((_a = notification.recipient) === null || _a === void 0 ? void 0 : _a.documentId) || ((_b = notification.recipient) === null || _b === void 0 ? void 0 : _b.id) || 'no-recipient';
